{
  ...
  "csv_structure": {
    ...
    "column_descriptions": {
      ...
      "layout_type": "Must be one of: dictionary_entry, minimalist_focus, bold_callout, header_body, quote_highlight, list_layout, stat_showcase, split_content, image_overlay, two_part_vertical, anti_marketing_hook, anti_marketing_content, anti_marketing_cta",
  ...
  "layout_types_and_requirements": {
    ...
    "anti_marketing_hook": {
      "description": "Brutalist hook slide with strapline, oversized title, and italic kicker",
      "required_fields": ["title", "subtitle", "body_text"],
      "field_usage": {
        "title": "Uppercase hook statement (keep it short)",
        "subtitle": "Upper strapline/label (e.g., 'ANTI MARKETING HOOK')",
        "body_text": "Short italic kicker or subtext"
      }
    },
    "anti_marketing_content": {
      "description": "Editorial content slide with header bar and accent rule",
      "required_fields": ["title", "body_text"],
      "field_usage": {
        "title": "Headline for the lesson/value",
        "subtitle": "Optional label shown in the header bar",
        "body_text": "Short punchy lines separated by <br /> or \\n"
      }
    },
    "anti_marketing_cta": {
      "description": "CTA card with heavy border, arrow, and underlined action text",
      "required_fields": ["title", "body_text"],
      "field_usage": {
        "title": "CTA headline (uppercase works best)",
        "subtitle": "Optional tag placed above the card",
        "body_text": "Action text (underlined automatically)"
      }
    }
  },
  ...
  "validation_checklist": [
    ...
    "layout_type matches one of the 13 supported types exactly",
